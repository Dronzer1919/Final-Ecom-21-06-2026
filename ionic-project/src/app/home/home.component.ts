...
@Component({
  selector: 'app-home',
  standalone: true,
  imports: [CommonModule, RouterModule, IonContent, HeaderComponent, ShimmerComponent, ThemeButtonComponent],
  ...
  loadData(): void {
    ...
    forkJoin({
      ...
      next: (results) => {
        ...
        // Process products
        const productList: Product[] = results.products.data?.products ?? [];
